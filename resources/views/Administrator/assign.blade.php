...
@section('page')
    ...
    <script>
        ...
        var dcc_office_link = "{{ route('add-office-user') }}";
        var po_office_link = "{{ route('add-office-user') }}";
        var dcc_program_link = "{{ route('add-program-user') }}";
        var po_process_link = "{{ route('add-process-user') }}";
        console.log(data);
